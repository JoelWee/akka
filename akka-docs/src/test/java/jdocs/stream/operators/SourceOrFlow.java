...
class SourceOrFlow {
  ...
  void mergePrioritizedExample() {
    ...
    sourceA.mergePrioritized(sourceB, 99, 1, false).runWith(Sink.foreach(System.out::print), system);
    ...
    try {
      sourceA.mergePrioritized(sourceB, 0, 99).runWith(Sink.ignore)
    } catch (IllegalArgumentException e) {
      System.out.println(e.getMessage())
      // requirement failed: Priorities should be positive ingtegers
    }
  }
